                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('store.cisco.phone')}}" onsubmit="return validateCiscoForm()" method="POST" enctype="multipart/form-data" id="storePhone">
                                        @csrf
                                ...
                                <div class="modal fade" id="UpdateCisco{{$phone->id}}" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('update.cisco.phone', ['id' =>$phone->id])}}" onsubmit="return validateForm()" method="POST" enctype="multipart/form-data" id="EditCisco{{ $phone->id}}">
                                                    @csrf
                                                    @method('PUT')
                                                    <label for="unit">Rigestrar Name:</label>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" id="model" value="{{ $phone->model }}" name="model" class="form-control" placeholder="">
                                                            <span class="error" id="modelError">Model is required.</span>
                                                            <br>
                                                        </div>
                                                    </div>
                                                    <label>SERIAL NUMBER</label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" id="serial_number" value="{{ $phone->serial_number }}" name="serial_number" class="form-control" placeholder="">
                                                            <span class="error" id="serialNumberError">Serial Number is required.</span>
                                                            <br>
                                                        </div>
                                                    </div>
                                                    <label>MAC ADDRESS</label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" id="mac_address" value="{{ $phone->mac_address }}" name="mac_address" class="form-control" placeholder="">
                                                            <span class="error" id="macAddressError">Please enter a valid MAC Address.</span>
                                                            <br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="date" id="date_added" value="{{ $phone->date_added }}" name="date_added" class="form-control" placeholder="">
                                                            <span class="error" id="dateAddedError">Date Added is required.</span>
                                                            <br>
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" value="Submit" form="EditCisco{{ $phone->id}}" class="btn btn-info waves-effect">Save</button>
                                                <button type="button" class="btn btn-danger waves-effect" data-dismiss="modal">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
