        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    ...
                    <span class="logo-name">Cisco Phone</span>
                </a>
            </div>
                    ...
                    <li class="dropdown user_profile">
                        <a href="#" onClick="return false;" class="dropdown-toggle" data-toggle="dropdown"
                            ...
                            <img src="{{ (!empty($profileData->photo)) ?
                                ...
                                :url('uploads/admin.jpg') }}" width="32" height="32" alt="User">
                        </a>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    <li class="sidebar-user-panel active">
                        <div class="user-panel">
                            <div class=" image">
                                <img src="{{ (!empty($profileData->photo)) ?
                                    url('uploads/image/'.$profileData->photo)
                                    :url('uploads/admin.jpg') }}" class="img-circle user-img-circle"
                                    alt="User Image" />
                            </div>
                        </div>
                    ...
                    <li>
                        <a href="{{ route('show.admin.province')}}">
